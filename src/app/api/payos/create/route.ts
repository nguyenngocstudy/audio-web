...
export async function POST(req: NextRequest) {
  ...
  console.log("[PayOS Create] planKey:", planKey, "orderCode:", orderCode);
  ...
  try {
    ...
    // Return thêm QR + bank info cho popup
    return NextResponse.json({
      checkoutUrl: paymentLink.checkoutUrl,
      orderCode:   String(orderCode),
      qrCode:      paymentLink.qrCode,        // base64 QR image từ PayOS
      accountName: paymentLink.accountName,   // Tên chủ TK
      accountNumber: paymentLink.accountNumber, // Số TK

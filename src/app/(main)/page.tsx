        ...
        <div className="relative overflow-hidden rounded-2xl mb-8"
          ...
          <div className="relative px-8 py-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium text-orange-300 bg-orange-500/20 border border-orange-500/30 mb-4">
              <i className="ti ti-flame" style={{ fontSize:13 }} />Nội dung mới mỗi tuần
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <a href="/#stories"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-medium text-white text-sm shadow-lg transition-all hover:scale-105"
                style={{ backgroundColor:"var(--accent)" }}>
                <i className="ti ti-player-play-filled" style={{ fontSize:16 }} />Khám phá ngay
              </a>
              <Link href="/vip"
                ...
                <i className="ti ti-crown-filled" style={{ fontSize:16 }} />Đăng ký VIP
              </Link>
            </div>
            <div className="flex flex-wrap gap-6 mt-8 pt-6 border-t border-white/10">
              {[
                { icon:"ti-book",     value:`${total}+`,   label:"Truyện"      },
                ...
                <div key={s.label} className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor:"var(--accent-light)" }}>
                    <i className={`ti ${s.icon}`} style={{ color:"var(--accent)", fontSize:15 }} />
                  </div>
                  <div>
        ...
        <div className="relative overflow-hidden rounded-2xl mb-8 p-5"
          ...
          <div className="relative flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-amber-200 text-sm">Nghe không giới hạn · Không quảng cáo · Chỉ từ 37.000đ/tháng</p>
            </div>
            <Link href="/vip"
              ...
              <i className="ti ti-star-filled" style={{ fontSize:15 }} />Đăng ký VIP
            </Link>
          </div>
        </div>
      )}
